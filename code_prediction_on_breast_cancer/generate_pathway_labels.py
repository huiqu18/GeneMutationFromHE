    ...
    for pathway, data in labels.items():
        ...
        for patient_name, label in data.items():
            if patient_name in train_patients:
                ...
                class_info_val[patient_name] = label
        ...
        freq_val = print_distribution(class_info_val)
        ...
        np.save('{:s}/val/{:s}_class_info_{:s}.npy'.format(data_train_dir, data_type, pathway), class_info_val)
